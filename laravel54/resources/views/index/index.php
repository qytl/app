        ...
        <div class="duya-header-bd clearfix">
            ...
            <div class="duya-header-nav">
                ...
                <div class="hy-nav-expand">
                    ...
                    <div class="hy-nav-title nav-main" id="nav-main"><a href="<?=url('index/type')?>">分类</a><i class="icon-arrow"></i></div>
                ...
                <div class="hy-nav-right un-login" style="display:block">
                    ...
                    <div class="hy-nav-title">
                        ...
                        <div class="un-login-btn">
                            ...
                            <i>|</i>
                            <a class="clickstat" id="nav-user" href="<?=url('index/user')?>" eid="click/navi/user" eid_desc="点击/导航/用户中心">用户中心</a>
