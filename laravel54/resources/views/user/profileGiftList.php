...
<head>
    ...
    <script src="//hm.baidu.com/hm.js?51700b6c722f5bb4cf39906a596ea41f"></script><script type="text/javascript" src="http://i.huya.com/base/js/jquery-1.7.2.min.js"></script><link rel="stylesheet" href="http://assets.dwstatic.com/b=lego/1.0.0/css&amp;f=mod.tips.css">
    <script type="text/javascript" src="http://i.huya.com/main/statics/js/WdatePicker.js"></script><link href="http://i.huya.com/main/statics/js/skin/WdatePicker.css" rel="stylesheet" type="text/css">
    <style type="text/css">
                        ...
                        <div id="tab-click" class="mod-tab">
                            ...
                            <div class="mod-tab-bd J_content">
                                <div class="mod-tab-content">
                                    <div class="calendar">
                                        <form id="timeSelect" name="timeSelect" action="http://i.huya.com/index.php?m=MyAccount&amp;do=profileGiftList&amp;from=profileIncome" method="post">

                                            <label>
                                                <i>时间</i>
                                                <input name="type" value="customize" type="hidden">
                                                <input class="Wdate" id="datetime" name="datetime" onfocus="WdatePicker({dateFmt:'yyyy年MM月dd日',vel:'realdateTime', minDate: '2017-09-01',maxDate: '2017-10-08',onpicked:function(){$('#timeSelect').submit();}})" value="2017年10月08日" type="text">
                                                <input id="realdateTime" name="realdateTime" value="2017-10-08" type="hidden">
                                            </label>
                                            ...
                                            <div class="contribute__total" style="float:right;margin-right:20px;">
                                                <div class="month__contribute">
                                                    每日更新前一天收到的礼物清单。礼物价值为礼物的金元宝价值，非分成后数值
                                                </div>
                                                <div class="year__contribute"></div>
                                            </div>
                                        </form>
                                    </div>
                                    <table>
...
<div class="gift-level-detail" id="detail_dialog">
    <table>
        ...
        <tr class="active">
            <td colspan="3">本月累计获得金元宝(未分成)：</td>
        </tr>
        </tbody>
    </table>
</div>
<div class="mod-tips-s2" id="gift_value_dialog" style="display: none; width: inherit; position: absolute;">
