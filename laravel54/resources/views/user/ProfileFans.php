    ...
    <div class="main-col">
        <div class="scroll-content">
            <div class="mod">
                    ...
                    <div class="mod-tab-content">
                        <div id="tab-click" class="mod-tab">
                            <div class="mod-tab-hd">
                                <ul class="mod-tab-trigger J_nav" id="proflie_fans_tab">
                                    <li class="selected"><a href="javascript:void(0);">我的粉丝</a></li>
                ...
                <!-- 我的粉丝s -->
                <!-- 已认证未12级 -->
                <div class="mod-bd no_fans my_fans">
                    <p class="no_fans_title">您还不是12级的认证主播，暂无徽章昵称设置权限</p>
                    <p>当前主播等级：<span class="level" style="background-position:0px -19px"></span>(保持足够开播时长，收到观众礼物，提高自己的主播等级)</p>
                    <p>主播认证情况：<a href="javascript:;" class="has_prove">已认证</a></p>
                </div>
                <!-- 已认证未12级e -->
                <!-- 已认证到12级e -->
                <!-- 我的粉丝e -->
                ...
                <!-- 操作记录s -->
                <div class="mod-bd operating_record" style="display:none;">
                    <ul class="record_contents">
                    </ul>
                    <div id="recordPage" class="mod-page"></div>
                </div>
                <!-- 操作记录e -->
            </div>
        </div>
...
<!-- 确定弹窗 -->
<div class="fans-box fans-box-sure-cancle">
    <div class="box_title">
        <p>提示</p>
        <a class="close_box" href="javascript:;"></a>
    </div>
    <div class="box_content">
        <i class="tips_icon"></i>
        <p>确定使用【<span>哈哈</span>】作为您的粉丝徽章昵称？</p>
    </div>
    <div class="box_bot">
        <a href="javascript:;" class="sure-btn">确定</a>
        <a href="javascript:;" class="cancel-btn close_box">取消</a>
    </div>
</div>

<div class="fans-box fans-box-only-sure">
    <div class="box_title">
        <p>提示</p>
        <a class="close_box" href="javascript:;"></a>
    </div>
...
<script type="text/javascript" src="//a.msstatic.com/huya/icenter/2.14/js/jquery.page.js"></script>
<script src="//a.msstatic.com/huya/icenter/2.43/js/profile_fans.js"></script></body></html>