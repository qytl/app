...
//签约申请
<html lang="en">
<html><head><script src="//hm.baidu.com/hm.js?51700b6c722f5bb4cf39906a596ea41f"></script>
    ...
    <script type="text/javascript" src="http://i.huya.com/base/js/jquery-1.7.2.min.js"></script><link rel="stylesheet" type="text/css" href="main/statics/css/anchor_sign.css">
    <link rel="stylesheet" type="text/css" href="http://a.msstatic.com/huya/icenter/2.20/css/qianyueshenqing-searchUtil.css?t=20161205">
    <script type="text/javascript" src="http://i.huya.com/main/statics/js/sign.js"></script>
    <script type="text/javascript">
        var isAuth = 1;
        var profileIsRetrieve = 0;
        var isInSignRequest = 0;
        var indexUrl = 'http://i.huya.com/';
        var cid = 0;
        var tipsStatus = 0;
        var tips = '';
        var liveUrl = 'http://www.huya.com/';
        var orderid = '2017100911263700126393955';
        function changeGetPercent() {
            var channelId = $('#channelId_value').val();

            if (channelId == '') {
                $("#profile_percent").empty().html("请输入正确的签约的频道号码");
            }

            var selecttime = $('#selecttime').val();
            if (selecttime == '') {
                $("#profile_percent").empty().html("请选择签约时限");
            }

            var ajaxCheckChannelURL = indexUrl + 'index.php?m=ProfileSign&do=changeGetPercent';
            $.post(
                ajaxCheckChannelURL,
                {
                    "channel": channelId,
...
//                $("#platinumUnion_plant").show();
                    if (response.status) {
                        if (response.data.isPlatinumUnion) {//白金
                            $("#profile_percent").empty().html((100-response.data.percent)+"%");
                            $("#platinumUnion_plant").hide();
                        }else{
                            $("#profile_percent").empty().html("70%");
                            $("#platinumUnion_plant").show();
                            $("#platinumUnion_profile_percent").empty().html((100-response.data.percent)+"%");
                        }

                    } else {
                        $("#profile_percent").empty().html(response.msg);
                    }
                },
                "json"
            );
    ...
    <style type="text/css">
        body .mod-anchor-setting .sign-content{
            height: 520px;
            background:url('http://a.msstatic.com/huya/icenter/2.12/img/post_bg.jpg') top left no-repeat;
        }
        .tips_wrap{
            width: 540px;
            height: 145px;
        ...
        .tips_wrap h5 span{
            ...
            margin-right: 6px;
            vertical-align: top;
            background:url('http://a.msstatic.com/huya/icenter/2.12/img/tips_icon.png') top left no-repeat;
        }
        #page span{
            padding: 0 0 0 20px;
            font-size: 14px;
...
<body><iframe src="//www.huya.com/act/proxy/storage.html" style="display: none;"></iframe><div class="duya-header" id="duya-header">
                ...
                <div class="scroll-content">
                    ...
                    <div class="nav-section" style="padding-bottom:0">
                        ...
                        <ul class="anchor-info">
                            ...
                            <li>
                                <a menu="sign" href="http://i.huya.com/index.php?m=ProfileSign" class="selected">
...
德州牌厅管理
    ...
    <div class="main-col">
        <div class="scroll-content">
            <div class="mod mod-anchor-setting">
                <div class="mod-hd">
                    <h3>签约申请</h3>
                </div>
                <div class="mod-bd">
                    <div class="sign-content">
                        <div class="sign-profile">
                            <img src="http://huyaimg.msstatic.com/avatar/1036/c9/81b3c8628d849cef72a0a91e26acbf_180_135.jpg?0" onerror="this.onerror='';this.src='http://huyaimg.msstatic.com/cdnimage/default/big_default_avatar.jpg'" alt="user">
                            <div class="sign-info">
                                <span class="level" style="float:left;background-position:0px -19px"></span>
                                <h3>吃嘛嘛香</h3>
                                <span class="channel">（1492160058）</span>
                                <p style="clear:both;margin-left:0;margin-top:30px;*margin-top:10px;color:#666666;">
                                    <span id="playExp" style="padding-right:20px;">经验：21</span>
                                    <span style="padding-right:20px;" data-uid="1350807054" id="subscribe">订阅：1</span>
                                    <!-- <span style="padding-right:20px;">直播时长：0小时</span> -->
                                </p>
                            </div>

                        </div>
                        <form class="form form-sign" action="about:blank" method="post" autocomplete="on" novalidate="" accept-charset="utf-8">
                            <!-- 不是企业认证 -->
                            <div class="form-group">
                                <label>申请签约的公会：</label>
                                <input id="channelId_value" name="cid" type="text" onblur="changeGetPercent();">
                                <input type="text" style="display:none">
                            </div>
                            <div class="form-group">
                                <label>签约时限：</label>
                                <select class="channel-select" name="selecttime" id="selecttime" style="" onchange="changeGetPercent();">
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                <label>主播提成：</label>
                                <span class="inline-text" id="profile_percent">70%</span>
                                <input type="text" style="display:none">
                            </div>
                            <div class="form-group" id="platinumUnion_plant" style="display:none;margin-bottom:0px;">
                                <label>成为白金公会后主播可提成：</label>
                                <span class="inline-text" id="platinumUnion_profile_percent">40%</span>
                                <input type="text" style="display:none">
                            </div>
                            <div class="tips_wrap" style="margin:8px auto;">
                                <h5><span></span>提示</h5>
                                <p>1. 主播与频道签约成功后，主播有义务在合约期内履行与公会的约定</p>
                                <p>2. 若签约频道成为白金公会将激活虎牙白金公会违约金条款，签约期内您将无法单方面与其解约。但您仍可以通过与该频道OW协商达成协议解约或支付违约金强制解约</p>
                                <p>3. 如需续约，在签约期满前7日，系统发起的续约弹窗需要主播个人进入个人中心操作确认续签，方可续约成功</p>
                            </div>
                            <div class="btn-group" style="margin: 10px auto 0;">
                                <a href="javascript:void(0)" id="signInit_id" class="btn btn-basic">提交申请</a> &nbsp;&nbsp;&nbsp;&nbsp; <span style="color: #989797;font-size: 12px;">提交申请7天后未通过自动取消</span>
                            </div>
                        </form>

                    </div>
                    <div class="tit__statistics sign_contract" style="margin-bottom:5px;display:none;">
                        <h4>签解约处理</h4>
                    </div>

                    &nbsp;&nbsp;&nbsp;&nbsp;

                    &nbsp;&nbsp;&nbsp;&nbsp;<table class="sign_contract" style="display:none;">
                        <thead>
                        <tr><th>发起时间</th>
                            <th>发起公会</th>
                            <th>类型</th>
                            <th>有效期</th>
                            <th>操作</th>
                        </tr></thead><tbody id="sign_contract"></tbody>
                    </table>
                    <div id="page" class="mod-page">

                    </div>
                    <div style="clear:both;"></div>
                    <div class="tit__statistics" style="margin-bottom:25px;" id="zhaoping-list">
                        <h4>推荐签约公会</h4>
                    </div>
                    <div class="sign-content" style="background:none;padding:0;height:1100px;">
                        <!-- <div class="sign-content" style="background:none;padding:0;"> -->
                        <!-- 频道招聘 -->
                        <div class="zhaopin">
                            <div style="width:100%;height:40px;position:relative;">
                                    <span class="zp-search" style="width:306px;float:right;margin-right:16px;">
                                        <input class="zp-search-input" type="search" value="搜索：游戏名、频道号、公会名或Y群号" onfocus="this.style.color='#333';if(this.value=='搜索：游戏名、频道号、公会名或Y群号')this.value='';" onblur="if(this.value=='')this.value='搜索：游戏名、频道号、公会名或Y群号'; this.style.color='#999';">
                                        <a class="zp-search-icon"></a>
                                    </span>
                                <ul class="zp-search-option">
                                    <li class="selected" t_name="renqi">人气排行</li>
                                    <li t_name="income">收入排行</li>
                                    <li t_name="time">新晋公会</li>
                                </ul>
                            </div>
                            <div class="zp-list"><div class="posDiv clearBoth"><div class="zp-list-item clearBoth"><span data-url="12560616"><img src="http://huyaimg.dwstatic.com/cdnimage/union/unionPic_1479973203.jpg?16ef27221dc8dba1302c72a3f7abcba2" onerror="this.onerror=null;this.src=&quot;http://i.huya.com/main/statics/img/channel_avater_default.jpg&quot; ;"></span><div><span class="title-intro" data-url="77259038">爱拍LOL</span><br><span data-url="12560616">频道号：90001</span><span>签约主播：390</span><span>创建时间：2016-05-27</span></div><div class="zp-list-bot"><span class="zp-list-bot-title">主营品类</span><span>英雄联盟  </span><span class="zp-list-bot-title">公会介绍</span><span class="zp-list-bot-intr-cls zp-list-bot-intr nohidden">爱拍原创旗下英雄联盟直播频道，24小时大神美女轮播不间断，拥有董小飒、卡尔、芜湖神、官人、董月月等超高人气大神主播，汇聚了陆雪琪、诺诺、小音、工藤瑶等虎牙人气美女主播。专注于培养中小型男女主播，打造爱拍草根明星。圆你一个主播梦！</span><span class="zp-list-bot-title">招聘信息</span><span class="nohidden">女主播LOL要求：长相优质，直播稳定，每天在线5个小时。
男主播要求：带上段位截图和电脑配置截图私聊黄马管理。钻石以上，看具体操作和口才，电脑最低配置：CPU：i5 3470+；显卡：1G以上；宽带下行10M以上，上行1M以上；内存：8G。</span><span class="zp-list-bot-title">联系方式</span><div class="zp-list-bot-contact"><span class="yy-qun">YY群号：14751428</span> </div></div></div></div><div class="posDiv  "><div class="zp-list-item  "><span data-url="12560616"><img src="http://huyaimg.dwstatic.com/cdnimage/union/unionPic_1479973453.jpg?bade1b346576114e326cc8d114715a29" onerror="this.onerror=null;this.src=&quot;http://i.huya.com/main/statics/img/channel_avater_default.jpg&quot; ;"></span><div><span class="title-intro" data-url="95431869">娱+LOL</span><br><span data-url="12560616">频道号：90077</span><span>签约主播：418</span><span>创建时间：2013-12-09</span></div><div class="zp-list-bot"><span class="zp-list-bot-title">主营品类</span><span>英雄联盟  </span><span class="zp-list-bot-title">公会介绍</span><span class="zp-list-bot-intr-cls zp-list-bot-intr nohidden">娱加90077官方英雄联盟直播频道，黑暗无边与娱加并肩。</span><span class="zp-list-bot-title">招聘信息</span><span class="nohidden">男主播要求：艾欧尼亚，大师，王者优先。或第一英雄系列，配置达标，直播风格搞笑幽默，应聘段位要求根据情况降低标准。
女主播要求：摄像头清晰，声卡麦克风设备齐全，段位无要求。</span><span class="zp-list-bot-title">联系方式</span><div class="zp-list-bot-contact"><span class="yy-qun">YY群号：13728702</span> </div></div></div></div><div class="posDiv clearBoth"><div class="zp-list-item clearBoth"><span data-url="12560616"><img src="http://huyaimg.dwstatic.com/cdnimage/union/unionPic_1479973292.jpg?e45845c323e32915657a0b327e0506e8" onerror="this.onerror=null;this.src=&quot;http://i.huya.com/main/statics/img/channel_avater_default.jpg&quot; ;"></span><div><span class="title-intro" data-url="99425467">正恒LOL</span><br><span data-url="12560616">频道号：90010</span><span>签约主播：414</span><span>创建时间：2011-08-29</span></div><div class="zp-list-bot"><span class="zp-list-bot-title">主营品类</span><span>英雄联盟  </span><span class="zp-list-bot-title">公会介绍</span><span class="zp-list-bot-intr-cls zp-list-bot-intr nohidden">虎牙直播频道，虎牙最赚钱公会，虎牙白金公会，优秀直播频道代表，年度最佳公会。24小时游戏直播频道，主玩英雄联盟，大神、美女带你齐欢乐，嗨翻天，还有公会陪玩、美女接待等你来。</span><span class="zp-list-bot-title">招聘信息</span><span class="nohidden">应聘联系QQ群与YY群</span><span class="zp-list-bot-title">联系方式</span><div class="zp-list-bot-contact"><span class="yy-qun">YY群号：100685</span><span class="qq-qun">QQ群号：258024021</span></div></div></div></div><div class="posDiv  "><div class="zp-list-item  "><span data-url="12560616"><img src="http://huyaimg.dwstatic.com/cdnimage/union/unionPic_1495011387.jpg?4619c71f73b756c1f792fdb173dbba46" onerror="this.onerror=null;this.src=&quot;http://i.huya.com/main/statics/img/channel_avater_default.jpg&quot; ;"></span><div><span class="title-intro" data-url="82519582">880青檬</span><br><span data-url="12560616">频道号：880</span><span>签约主播：350</span><span>创建时间：2013-12-29</span></div><div class="zp-list-bot"><span class="zp-list-bot-title">主营品类</span><span>英雄联盟  星秀  </span><span class="zp-list-bot-title">公会介绍</span><span class="zp-list-bot-intr-cls zp-list-bot-intr nohidden">娱加880官方英雄联盟直播频道，黑暗无边与娱加并肩。</span><span class="zp-list-bot-title">招聘信息</span><span class="nohidden">男主播要求：艾欧尼亚，大师，王者优先。或第一英雄系列，配置达标，直播风格搞笑幽默，应聘段位要求根据情况降低标准。 女主播要求：摄像头清晰，声卡麦克风设备齐全，段位无要求。</span><span class="zp-list-bot-title">联系方式</span><div class="zp-list-bot-contact"><span class="yy-qun">YY群号：1184737</span> </div></div></div></div><div class="posDiv clearBoth"><div class="zp-list-item clearBoth"><span data-url="12560616"><img src="http://huyaimg.dwstatic.com/cdnimage/union/unionPic_1479973220.jpg?16ef27221dc8dba1302c72a3f7abcba2" onerror="this.onerror=null;this.src=&quot;http://i.huya.com/main/statics/img/channel_avater_default.jpg&quot; ;"></span><div><span class="title-intro" data-url="27899470">爱拍官方</span><br><span data-url="12560616">频道号：90088</span><span>签约主播：394</span><span>创建时间：2015-11-04</span></div><div class="zp-list-bot"><span class="zp-list-bot-title">主营品类</span><span>主机游戏  我的世界  </span><span class="zp-list-bot-title">公会介绍</span><span class="zp-list-bot-intr-cls zp-list-bot-intr nohidden">爱拍90088单机是具有突破力度的一个频道。打造虎牙最顶尖的直播内容。主播互动沟通文娱精通.我们不断突破自己。做出最好的直播内容。</span><span class="zp-list-bot-title">招聘信息</span><span class="nohidden">只要你有风格，稳定直播。我们就可以包装你 ，让你成为千人万人主播。 还等待什么。抓紧加入爱拍。让你在玩着游戏也能赚着钱。想应聘的加管理好友！考核频道90088</span><span class="zp-list-bot-title">联系方式</span><div class="zp-list-bot-contact"><span class="yy-qun">YY群号：14306762</span> </div></div></div></div><div class="posDiv  "><div class="zp-list-item  "><span data-url="12560616"><img src="http://huyaimg.dwstatic.com/cdnimage/union/unionPic_1483408860.jpg?8c3bebf544c348115d2c26dc1e20213a" onerror="this.onerror=null;this.src=&quot;http://i.huya.com/main/statics/img/channel_avater_default.jpg&quot; ;"></span><div><span class="title-intro" data-url="45076172">正恒手游</span><br><span data-url="12560616">频道号：90493</span><span>签约主播：269</span><span>创建时间：2016-06-13</span></div><div class="zp-list-bot"><span class="zp-list-bot-title">主营品类</span><span>球球大作战  王者荣耀  皇室战争  怪兽大作战  阴阳师  街篮  火影忍者手游  </span><span class="zp-list-bot-title">公会介绍</span><span class="zp-list-bot-intr-cls zp-list-bot-intr nohidden">24小时优质直播不间断，每天精彩直播内容。大神主播；王者荣耀官方解说狂人，逗比荣耀宇1，实力大神成成，街篮王者kk，皇室战争职业选手、比赛解说、一切精彩直播内容尽在这里。加入我们。</span><span class="zp-list-bot-title">招聘信息</span><span class="nohidden">1、招收王者荣耀、皇室战争、街篮、怪兽大作战、火影忍者、阴阳师、蛇蛇争霸、各种类型的手游游戏主播。
2、只要你有业余时间、热爱游戏、热爱直播。
3、形象好、气质佳、口才好、麦音清晰无杂音有良好的设备和稳定的直播环境。
4、性格开朗、思维活跃、有耐心。
5、表达能力强积极乐观，对游戏有一定的熟练度。请通过下方招聘群联系我们~</span><span class="zp-list-bot-title">联系方式</span><div class="zp-list-bot-contact"><span class="yy-qun">YY群号：14799057</span><span class="qq-qun">QQ群号：555752580</span></div></div></div></div><div class="posDiv clearBoth"><div class="zp-list-item clearBoth"><span data-url="12560616"><img src="http://huyaimg.dwstatic.com/cdnimage/union/unionPic_1482745068.jpg?7d8fd952a3a1a43f22352568c7877821" onerror="this.onerror=null;this.src=&quot;http://i.huya.com/main/statics/img/channel_avater_default.jpg&quot; ;"></span><div><span class="title-intro" data-url="10904320">正恒球球</span><br><span data-url="12560616">频道号：90596</span><span>签约主播：291</span><span>创建时间：2016-11-30</span></div><div class="zp-list-bot"><span class="zp-list-bot-title">主营品类</span><span>球球大作战  </span><span class="zp-list-bot-title">公会介绍</span><span class="zp-list-bot-intr-cls zp-list-bot-intr nohidden">正恒旗下唯一球球大作战直播频道，旗下拥有球球大神主播疯子（球球生存第一人），球球大神主播老白（皮肤总榜第一人），球球大神主播祈梦（团战套路之王），声优美女蜜糖，热浪，球球生存大神子晨，天真等，保证让你学得了技术，玩得了圈子，泡得了妹子，期待各位的鼎力加盟！</span><span class="zp-list-bot-title">招聘信息</span><span class="nohidden">做主播月入过万不是梦，本频道大量招收球球大作战主播、游戏解说、视频UP主以及视频女主播。优秀者可线下签约，包捧，一切请加YY群8110966咨询群管。最一流的资源，最专业的团队，最好的服务，打造虎牙一流直播频道！
★考核男主播要求：技术过硬 麦克风清晰无杂音 有较好的和粉丝之间的互动性
★考核女主播要求：优质女生，无段位要求，外貌姣好 有才艺优先
★电脑直播的配置要求:
20兆光纤及以上
显卡：GTX750ti以上（最低2GB）
CUP：Intel酷睿i5及以上
内存：8GB及以上</span><span class="zp-list-bot-title">联系方式</span><div class="zp-list-bot-contact"><span class="yy-qun">YY群号：8110966</span><span class="qq-qun">QQ群号：6617091</span></div></div></div></div><div class="posDiv  "><div class="zp-list-item  "><span data-url="12560616"><img src="http://huyaimg.dwstatic.com/cdnimage/union/unionPic_1481019582.jpg?4ad9152e87185e9754e9e46f8bca3266" onerror="this.onerror=null;this.src=&quot;http://i.huya.com/main/statics/img/channel_avater_default.jpg&quot; ;"></span><div><span class="title-intro" data-url="81028608">众娱传媒</span><br><span data-url="12560616">频道号：90808</span><span>签约主播：334</span><span>创建时间：2016-08-11</span></div><div class="zp-list-bot"><span class="zp-list-bot-title">主营品类</span><span>主机游戏  我的世界  星秀  </span><span class="zp-list-bot-title">公会介绍</span><span class="zp-list-bot-intr-cls zp-list-bot-intr nohidden">众娱传媒单机频道。打造虎牙最顶尖的直播内容。我们这里是明星学院，黄埔军校，有电视台专业主持培训，我们不断突破自己，做出最好的直播内容。</span><span class="zp-list-bot-title">招聘信息</span><span class="nohidden">只要你有直播梦，只要你稳定，只要你技术够硬，来找我，圆你梦想 还等待什么。抓紧加入吧，让你玩游戏也能开豪车、住别墅、赚大钱。</span><span class="zp-list-bot-title">联系方式</span><div class="zp-list-bot-contact"><span class="yy-qun">YY群号：14919918</span><span class="qq-qun">QQ群号：346897321</span></div></div></div></div></div>
                            <div class="zhaopin-page mod-page" style="margin-right: 40px;"><a href="javascript:void(0)" title="已经是当前页" class="current" data-page="0">1</a><a href="javascript:void(0)" title="第2页" data-page="1">2</a><a href="javascript:void(0)" title="第3页" data-page="2">3</a><a href="javascript:void(0)" title="第4页" data-page="3">4</a><a href="javascript:void(0)" title="第5页" data-page="4">5</a></div>
                            <div style="clear:both;"></div>
                        </div>
                    </div>
...
<div class="pop-box-content">
    ...
    <div class="box" id="popup-win4" style="">
        <div class="box-hd">
            <h3 class="title">解除签约</h3>
            <a href="#1" class="btn-close J_btnClose" title="关闭">关闭</a>
        </div>
    ...
    <div class="box" id="popup-win7-1" style="">
        <div class="box-hd">
            <h3 class="title">提示</h3>
            <a href="#1" class="btn-close J_btnClose" title="关闭">关闭</a>
        </div>
    ...
    <div class="box" id="popup-win7" style="">
        <div class="box-hd">
            <h3 class="title">提示</h3>
            <a href="#1" class="btn-close J_btnClose" title="关闭">关闭</a>
        </div>
    ...
    <div class="box" id="popup-win7-2" style="">
        <div class="box-hd">
            <h3 class="title">提示</h3>
            <a href="#1" class="btn-close J_btnClose" title="关闭">关闭</a>
        </div>
    ...
    <div class="box" id="popup-win7-3" style="">
        <div class="box-hd">
            <h3 class="title">提示</h3>
            <a href="#1" class="btn-close J_btnClose" title="关闭">关闭</a>
        </div>
    ...
    <div class="box" id="popup-win22" style="">
        <div class="box-hd">
    ...
    <div class="box" id="popup-win23" style="">
        <div class="box-hd">
    ...
    <div class="box" id="popup-win26" style="">
        <div class="box-hd">
    ...
    <!-- 向频道续签 弹窗-->
    <div class="box" id="renewSign-popbox" style="">
        <div class="box-hd">
            <h3 class="title">续签</h3>
            <a href="javascript:;" class="btn-close J_btnClose" title="关闭">关闭</a>
        </div>

        <div class="box-bd" style="overflow:hidden;">
            <div class="cont" style="padding: 20px 80px;">

                <form class="form" action="about:blank" method="post" autocomplete="on" novalidate="" accept-charset="utf-8">
                    <div class="form-group">
                        <span>你将向公会<span></span>发起续签的申请。</span>
                    </div>
                    <div class="form-group">
                        <label class="tit-i" for="renewTimeOneYear">续签时间：</label>
                        <label for="renewTimeOneYear" style="width: auto;color:#000;float:left;height:30px;margin-right:8px;line-height:30px;">
                            <input id="renewTimeOneYear" name="renewTime" checked="checked" type="radio" style="border:none; height:30px;"> 1年
                        </label>
                        <label class="tit-i" for="renewTimeThreeYear" style="width: auto;color:#000;float:left;height:30px;margin-right:8px;line-height:30px;">
                            <input id="renewTimeThreeYear" name="renewTime" type="radio" style="border: none; height:30px;"> 3年
                        </label>
                    </div>
                    <div class="form-group">
                        <label class="tit-i">主播分成：</label>
                        <span style="height:30px;font-size:12px;line-height:30px;">
                            <span id="currentPercent">0</span>%
                        </span>
                    </div>
                </form>
                <div class="btn-group">
                    <span class="ui-button J_btnConfirm"> <a href="javascript:;" class="btn btn-confirm" onclick="anchorRenewSignUtil.submitRenewSign();">确定</a></span>
                    <span class="ui-button ui-button-gray J_btnCancle"><a href="#1" class="btn btn-cancel">取消</a></span>
                </div>
            </div>
        </div>
    ...
    <!-- 结果 -->
    <div class="box" id="renewSignResult-popbox" style="">
        <div class="box-hd">
            <h3 class="title">提示</h3>
            <a href="javascript:;" class="btn-close J_btnClose" title="关闭">关闭</a>
        </div>
        <div class="box-bd">
            ...
            <div class="cont cont-tips">
                <i class="tips-verify">
                    <p id="renewSignResultIcon" class="icon icon-error" style="float:left;"></p>
                    <span id="renewSignResultInfo" class="content_span" style="margin-top: 15px;"></span>
                </i>
                <div class="btn-group">
                    <span class="ui-button J_btnConfirm"> <a href="javascript:;" class="btn btn-confirm">确定</a></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- 签解约处理弹窗 -->
    <div class="box" id="sign_contract-popbox" style="margin:-160px 0 0 -215px;">
        <div class="box-hd">
    ...
    <!-- <script type="text/javascript" src="http://szhuodong.duowan.com/s/zbzs/js/recruit_data.js?20150413"></script> -->
    <!--<script type="text/javascript" src="http://assets.dwstatic.com/project/yytv/center/2.9.2/js/qianyueshenqing-searchUtil-new.js?t=20150618"></script>-->
    <script type="text/javascript" src="http://a.msstatic.com/huya/icenter/2.20/js/qianyueshenqing-searchUtil.js?t=20161205"></script>

    <script type="text/javascript">
        //初始化频道招聘搜索面板
        var url = "http://i.huya.com/index.php?m=Union&do=getUnionList";
        searchUtil.init({"url":url,"pageSize":8});
    </script>

    <script type="text/javascript">
        var anchorRenewSignPopBox = LEGO.popupBox("#renewSign-popbox", {
            ok: function(dt) {

            },
            existMask: true,
            cancle: function(dt) {
                anchorRenewSignPopBox.close();
            }
        }, {});

        //操作结果
        var anchorRenewSignResultBox = LEGO.popupBox("#renewSignResult-popbox", {
            ok: function(dt) {
                anchorRenewSignResultBox.close();
            },
            existMask: true,
            cancle: function(dt) {
                anchorRenewSignResultBox.close();
    ...
    <script type="text/javascript">
        ...
        $(function(){
            // 获取主播信息
            $.post('http://i.huya.com/index.php?m=ProfileInfo&do=getProfileInfo',{},function(res){

                res = $.parseJSON(res);

                if(res.status === 200){
                    // 写入主播等级
                    $('#playExp').html('经验：' + res.data.exp);
                }

            });
            // 点击频道头像、名字和频道号跳转到频道直播间
            $('.to_live_house').live('click',function(){
                var num = '' + $(this).data('url'),
                    url;

                if( (num.length === 5 || num.length === 6) && num.substr(0,2) === '90' ){
                    url = 'http://www.huya.com/' + num;
                }else{
                    url = 'http://www.huya.com/c/' + num;
                }
        ...
        $.ajax({
            type:'get',
            url:'http://api.huya.com/subscribe/getSubscribedCount',
            data:{
                to_type:2,
                to_key:$('#subscribe').data('uid')
            },
            dataType:'jsonp'
        }).then(function(res){
            window.console && console.log("订阅返回：");
            window.console && console.log(res);
            if(res.result === 0){
                $('#subscribe').append(res.subscribe_count || 0);
            }
        });

    </script>
    <script type="text/javascript" src="http://assets.dwstatic.com/project/yytv/center/2.9.1/js/renew_sign.js"></script>
    <script type="text/javascript" src="http://a.msstatic.com/huya/icenter/2.14/js/jquery.page.js"></script>
    <script type="text/javascript" src="http://a.msstatic.com/huya/icenter/2.41.1/js/profile_sign_contract.js"></script>
