                ...
                <div class="scroll-content">
                    <div class="nav-section" style="padding-bottom:0">
                        ...
                        <ul class="icon-filter">
                            <li>
                                <a menu="home" href="?r=index/user" class="selected">
                            ...
                            <li>
                                <a menu="userlevel" href="?r=center/szt">
        ...
        <div class="scroll-content">
            <div class="mod mod-user-center">
                ...
                <div class="user_info">
                    ...
                    <!-- 非第三方登陆，显示修改昵称、密码 -->
                    <div class="change">
                        <p class="change_top"><img src="http://a.msstatic.com/huya/icenter/2.4/img/warn.png" alt="">字段包含敏感字符，请重新输入</p>
                    ...
                    <ul id="my_estate">
                        <li>
                            ...
                            <span class="tool-info">
                                        <i class="num" style="min-width:28px;">666</i>
                                                                                    <span class="tool_msg hidden">
                                                <i class="up_arrows"></i>
                                                <span class="tool_msg_span">金豆：666</span>
                                            </span>
                                                                                <i class="line"></i>
                                    </span>
                        </li>
                        <li>
                            ...
                            <span class="tool-info">
                                        <i class="num" style="min-width:28px;">61张</i>
                                                                                    <span class="hidden tool_msg">
                                                <i class="up_arrows"></i>
                                                <span class="tool_msg_span">金豆券：61张</span>
                                            </span>
                                                                                <i class="line"></i>
                                    </span>
                        </li>
                        ...
                        <li>
                            ...
                            <span class="tool-info">
                                        <i class="num" style="min-width:28px;">20</i>
                                                                                    <span class="hidden tool_msg">
                                                <i class="up_arrows"></i>
                                                <span class="tool_msg_span">银豆：20</span>
                                            </span>
                                                                                <i class="line"></i>
                                    </span>
                        </li>
