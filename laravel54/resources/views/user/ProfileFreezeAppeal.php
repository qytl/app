...
<script>
    var currentMenu = 'profileFreezeAppeal',
...
<script type="text/javascript" src="//a.msstatic.com/huya/icenter/1.0/js/cookies.js"></script>
    ...
    德州牌厅管理
        ...
        <div class="main-col">
                <div class="scroll-content">
                        ...
                        <div id="showViolationData">

        <p class="mod-title">账号状态：<span class="normal">正常</span></p>



        <div class="mod-content-normal">
                <img src="//a.msstatic.com/huya/icenter/main/img/normal_bd7944a.png" height="125">
                <p>请继续保持绿色直播！</p>
        </div>
    ...
    <!-- 申诉弹窗 -->
    <div class="appeals-box the-box">
        <div class="appeal-box-title">
                <p>申诉填写</p>
                <a href="javascript:;" class="close"></a>
        </div>
        <div class="appeal-box-content">
                <input class="appeal-phone" placeholder="请填写手机号码（必填项）" id="phone" type="text">
                <textarea name="" maxlength="200" id="appealReason" class="appeal-reason" cols="30" rows="10" placeholder="请填写申诉理由（不少于10字）"></textarea>
                <p class="error"></p>
        </div>
        <div class="appeal-box-bottom">
                <a href="javascript:;" class="appeal-submit">提交申诉</a>
        </div>
    </div>
    <!-- 申诉成功 -->
    <div class="appeals-success-box the-box">
        <div class="appeals-success-box-title">
                <p>提示</p>
                <a href="javascript:;" class="close"></a>
        </div>
        <div class="appeals-success-box-content">
                <p>申诉已提交，虎牙直播官方将在三个工作日内完成审核，请留意审核结果。</p>
        </div>
        <div class="appeals-success-box-bottom">
                <a href="javascript:;" class="appeals-success-submit">确认</a>
        </div>
    </div>
...
<script src="//a.msstatic.com/huya/icenter/main/js/freeze_appeal_80738f8.js"></script></body>