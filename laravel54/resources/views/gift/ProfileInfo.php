<!doctype html>
<html lang="en">
<head><script src="//hm.baidu.com/hm.js?51700b6c722f5bb4cf39906a596ea41f"></script>
                            ...
                            <div class="u-info">
                                ...
                                <div class="exp clearfix">
                                    <div class="between">
                                        ...
                                        <div class="bar-cnt">
                                            <p id="J_huyaNavUserCardBarInfo">今日获得<em>0</em>点经验值，升级还需<em>145</em>点</p>
                                            <p class="bar">
                                                <i id="J_huyaNavUserCardExpBar" style="width: 27.5%;"><b class="J_huyaNavUserCardExpText">55/200</b></i>
                                                <span class="J_huyaNavUserCardExpText">55/200</span>
                                            </p>
                                        </div>
                                    ...
                                    <div class="mod-bd">
                                        ...
                                        <ul class="tasks">
                                            ...
                                            <li>
                                                ...
                                                <span class="task-icon" title="订阅主播数量大于等于5名"><img src="//img.dwstatic.com/huya/questcenter/icon/xinshou_dingyue.png" alt="icon"></span>
                                                <p class="task-name" title="订阅主播数量大于等于5名">订阅主播</p>

                                                <a class="task-btn ing" href="#">0/5</a>
                                            ...
                                            <li>
                                                ...
                                                <span class="task-icon" title="对心爱的主播送出玉兔"><img src="//img.dwstatic.com/huya/questcenter/icon/xinshou_songli.png" alt="icon"></span>
                                                <p class="task-name" title="对心爱的主播送出玉兔">送出玉兔</p>
...
德州牌厅管理
    ...
    <div class="anchor-col">
        <div class="anchor-content">
            <div class="user-profile" style="background:#fff;">
                <h3 class="head-title">主播信息</h3>
                <div class="user-pic">
                        <span class="img-wrap" id="userImgWrap">
                            <span class="img-shot">
                ...
                <div class="user-data">
                    ...
                    <div id="changeNick" style="float:left;margin-left:40px;display:none;">
                        <input id="nickInput" style="background: 0;border: 0;width: 177px;height: 35px;line-height: 35px;color: #333;outline: 0;padding: 0;font-size: 2.5em;border: 1px solid #e0e0e0;float: left;" type="text">
                    ...
                    <script>
                        $(document).ready(function(){
                            ...
                            //确定修改
                            $("#btnNickSure").on("click",function(){
                                var anchor_nick = $('#nickInput').val();
                                ...
                                $.post( indexUrl + "index.php?m=ProfileInfo&do=updateNick",{
                                    nick:anchor_nick
                                },function(re){
                                    var res = $.parseJSON(re);
                                    if(res.status === 200){
                                        report({//修改昵称数据成功埋点2016-7-18
                                            eid:"click/grzx/zbxx/xgnccg",
                                            eid_desc:"点击/个人中心/主播信息/修改昵称成功"
                                        });
                                        alert('已修改成功！');
                                        location.reload();
                                    }else{
                            ...
                            var theDay = theDate.getFullYear() + "-" + ( theDate.getMonth() + 1 ) + "-" + theDate.getDate();
                            if(theDay == "2016-8-1"){
                                $("#changeNickA").hide();
                            }*/
                        });
                    ...
                    <!-- 修改昵称end -->
                    <span class="chanel-title-name">认证主播<i id="goSign" data-url="<?=url('index/ProfileSign')?>">去签约</i></span>


                    <div class="nickname-refresh" onclick="profile_util.refreshProfileInfo();">
                        <div class="tips tips-nickname">
                            <div class="tips-content">
                                <p class="txt" style="text-align:center">刷新</p>
                                <i class="arrow arrow-up"></i>
                            </div>
                        </div>
                    </div>

                    <a href="http://cvcharge.yyembed.yy.com/auth/index?appid=10057&amp;uid=1350807054&amp;level=10" target="_blank" class="pay_bail_in" style="width: 60px;float: left;">充值保证金</a>
                    <!-- 提示文案 -->
                    <!-- <div id="hint" style="float: left;margin-left: 10px;color:red;clear:both;width:100%;">在8月1日前可修改主播昵称，8月1日后将无法修改，请谨慎修改</div> -->
                    <!-- 提示文案end -->
                    <div class="freeze-zone" style="margin: 0 0 0 5px;font-size:12px;">
                        <span class="freeze">直播权限被冻结。</span>
                        <a href="#" class="unretrieveProfile" style="font-size:12px;">重新激活</a>
                    </div>

                    <div class="live-info">
                            <span class="live-time">
                                <i id="exprience" style="margin-left: 5px;">经验：21</i>
                                <i style="margin-left: 5px;" class="subscribe" data-uid="1350807054" id="subscribe">订阅：1</i>
                            </span>
                    </div>
                </div>
            </div>
            <div class="anchor-basic"></div>
            <div class="anchor__main">
                <!--S 直播人气统计-->
                <div class="live__statistics">
                    <div class="tit__statistics">
                        <h4>主播人气值峰值</h4>
                    </div>
                    <div id="tab1" class="mod-tab__live">
                        <div class="mod-tab-hd">
                            <ul class="mod-tab-trigger " id="chartTab">
                                <li data-month="1" class="selected"><a href="javascript:void(0);" class="">本月</a></li>
                                <li data-month="-1"><a href="javascript:void(0);"><span class="d_last_month">9</span>月</a></li>
                                <li data-month="-2"><a href="javascript:void(0);"><span class="d_before_month">8</span>月</a></li>
                            </ul>
                        </div>
                        <div class="mod-tab-bd J_content">
                            <div class="mod-tab-content">
                                <ul class="statistics__intro">
                                    <!--<li><i class="square__red"></i>DAU</li>-->
                                </ul>
                                <div id="main" style="height: 325px; background-color: rgba(0, 0, 0, 0); cursor: default;" _echarts_instance_="1507515057743"><div style="position: relative; overflow: hidden; width: 780px; height: 325px;"><div style="position: absolute; left: 0px; top: 0px; width: 780px; height: 325px; -moz-user-select: none;" width="780" height="325" data-zr-dom-id="bg"></div><canvas style="position: absolute; left: 0px; top: 0px; width: 780px; height: 325px; -moz-user-select: none;" width="780" height="325" data-zr-dom-id="0"></canvas><canvas style="position: absolute; left: 0px; top: 0px; width: 780px; height: 325px; -moz-user-select: none;" width="780" height="325" data-zr-dom-id="1"></canvas><canvas style="position: absolute; left: 0px; top: 0px; width: 780px; height: 325px; -moz-user-select: none;" width="780" height="325" data-zr-dom-id="2"></canvas><canvas style="position: absolute; left: 0px; top: 0px; width: 780px; height: 325px; -moz-user-select: none;" width="780" height="325" data-zr-dom-id="3"></canvas><canvas style="position: absolute; left: 0px; top: 0px; width: 780px; height: 325px; -moz-user-select: none;" width="780" height="325" data-zr-dom-id="8"></canvas><canvas style="position: absolute; left: 0px; top: 0px; width: 780px; height: 325px; -moz-user-select: none;" width="780" height="325" data-zr-dom-id="_zrender_hover_"></canvas></div></div>
                                <div class="live__time live-time-week">
                                    <span class="day__ave">日均人气值峰值：<strong id="week_avg_pcu">0</strong></span>
                                </div>
                            </div>
                        </div>
                        <p>注释：人气值峰值为当天人气值的最大值。人气值数据，是结合“打击外挂“、”协议去重”等策略得出的最终数值，与以往的PCU数据不同。</p>
                    </div>
                </div>
                <!--E 直播人气统计-->
                ...
                <div class="live__statistics">
                    ...
                    <div class="mod-tab__live">
                        <div class="mod-tab-hd">
                            <ul class="mod-tab-trigger" id="historyTab">
                                <li data-month="1" class="selected"><a href="javascript:void(0);" class="">本月</a></li>
                                <li data-month="-1"><a href="javascript:void(0);"><span class="d_last_month">9</span>月</a></li>
                                <li data-month="-2"><a href="javascript:void(0);"><span class="d_before_month">8</span>月</a></li>
                            </ul>
                            ...
                            <div class="mod-tab-content">
                                <div class="history_inner">
                                    <table id="historyTable">
                                        ...
                                        <tbody><tr><td colspan="3">暂无历史记录</td><td></td><td></td></tr></tbody>
                                        <!--<tr>
                                            <td>2016.2.2</td>
                                            <td>9小时46分钟</td>
                                            <td><a>查看</a></td>
                        ...
                        <div class="live__time total_pcu">
                            <span class="day__ave">本月直播时长：<span id="totalLiveTime"><strong>0</strong>秒</span></span>
                        </div>
                    </div>
                ...
                <!--S 主播等级成长 -->
                <div class="live__statistics profile-level" style="position:relative;">
                    <a href="http://hd.huya.com/level_intro/index.html#J_la" class="how_improve_class" target="_blank" title="如何提升等级">如何提升等级</a>
                    <div class="tit__statistics" style="margin-bottom:36px;">
                        <h4>主播等级成长</h4>
                    </div>
                    <div class="profile-level-info" id="profile_level_info" style="display: block;">
                        <div id="level_progress" class="progress" title="成长值:0">
                            <div id="level_progress_bar" class="progress-bar progress-bar-warning" style="width: 21%;"></div>
                        </div>
                        <span class="level-text level-text-now">当前等级：<i id="nowLevel">1</i>级</span>
                        <span class="level-text level-text-next">下一等级：<i id="nextLevel">2</i>级</span>
                        <span class="level_grey_icon"></span>
                        <span class="exp_item now_exp" id="nowExp" style="left: 27px;">21</span>
                        <span class="exp_item next_exp" id="nextExp">100</span>
                    </div>
                    <div id="profile_level_info_null" style="display:none;text-align:center">
                        暂无等级，请先去<a href="http://i.huya.com/index.php?m=ProfileAuth" target="_blank">实名认证</a>
                    </div>
                </div>
                <!--E 主播等级成长 -->

                <!--S 主播成长指引 -->
                <div class="live__statistics profile-level">
                    <div class="tit__statistics" style="margin-bottom:25px;">
                        <h4>主播成长指引</h4>
                    </div>
                </div>
                <!--E 主播成长指引 -->
                ...
                <!-- 手风琴模块{ -->
                <div class="mod-accordion-anchor">
                    <!--                      <div class="mod-hd J_nav">
                                             <span class="label__status label__status--now"></span>
                                             <h4>你现在是，主播等级1级</h4>
                                             <span class="expand-panel">查看所享有的特权<i class="panel__arrow"></i></span>
                                         </div> -->
                    <div class="" style="display:block">
                        <ul class="anchor__level">
                            <li class="level__status--active level__status__normal level__status--tab">
                                普通主播
                                <span>（已获特权）</span>
                                <i></i>
                            </li>
                            ...
                            <li class=" level__status__normal level__status--tab">
                                频道签约主播
                                <i></i>
                            </li>
                            <li class=" level__status__normal level__status--tab" style="margin-right:0;">
                                官方签约主播
                            </li>
                        </ul>
                        <div class="mod-panel__content">
                            ...
                            <div class="mod-panel__welfare mod__welfare">
                                <div class="mod__bd">
                                    <div class="tab-click mod-tab__welfare">
                                        <div class="mod-tab-bd J_content">
                                            <div class="mod-tab-content">
                                                <div class="mod-tab__hover">
                                                    <div class="mod-tab-hd">
                                                        <ul class="mod-tab-trigger J_nav">
                                                            <li><em>1</em>一键开播，享受三端同步的畅快直播体验</li>
                                                            <li><em>2</em>拥有专属的主播个人空间，彰显自我</li>
                                                            <li><em>3</em>粉丝系统，助您涨粉丝涨人气</li>
                                                            <li><em>4</em>官方给予明确的主播晋升通道</li>
                                                        </ul>
                                                    </div>
                                                    <div class="mod-tab-bd J_content">
                                                        <div class="mod-tab-content">
                                                            <p>第一次？不用紧张，点我查看帮助</p>
                                                            <a href="http://help.huya.com/index.php?m=Help&amp;item=profile" target="_blank" class="btn btn__apply">新手主播帮助</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="mod-panel__welfare mod__welfare" style="display:block;">
                                <div class="mod__bd">
                                    <div class="tab-click mod-tab__welfare">
                                        <div class="mod-tab-bd J_content">
                                            <div class="mod-tab-content">
                                                <div class="mod-tab__hover">
                                                    <div class="mod-tab-hd">
                                                        <ul class="mod-tab-trigger J_nav">
                                                            <li><em>1</em>开启等级晋升通道，享受等级特权待遇</li>
                                                            <li><em>2</em>所得道具可进行佣金提现</li>
                                                            <li><em>3</em>公会推荐系统，助您第一时间找对公会组织</li>
                                                            <li><em>4</em>优秀认证主播将通过系统推送到各大白金公会</li>
                                                        </ul>
                                                    </div>
                                                    <div class="mod-tab-bd J_content">
                                                        <div class="mod-tab-content">
                                                            <p>还没认证？马上跨出成名的第一步！</p>
                                                            <a href="javascript:;" class="btn btn__apply" style="background:#ccc;">您已认证</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mod-tab-bd J_content">
                                            <div class="mod-tab-content">
                                                <div class="mod-tab__hover">
                                                    <div class="mod-tab-hd">
                                                        <ul class="mod-tab-trigger J_nav">
                                                            <li><em>1</em>与白金公会签约，尽享公会资源，让公会为您争取更多福利</li>
                                                            <li><em>2</em>美女、大神各式标签，等你来摘</li>
                                                            <li><em>3</em>白金主播头衔，双手为土豪主播奉上</li>
                                                            <li><em>4</em>每月定期会议，预告官方运营动态</li>
                                                        </ul>
                                                    </div>
                                                    <div class="mod-tab-bd J_content">
                                                        <div class="mod-tab-content">
                                                            <p>找对组织很重要，去看看有什么靠谱公会吧</p>
                                                            <a href="http://i.huya.com/index.php?m=ProfileSign" target="_blank" class="btn btn__apply">申请</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mod-tab-bd J_content">
                                            <div class="mod-tab-content">
                                                <div class="mod-tab__hover">
                                                    <div class="mod-tab-hd">
                                                        <ul class="mod-tab-trigger J_nav">
                                                            <li><em>1</em>与虎牙官方签订合约，享受最高规格特权</li>
                                                            <li><em>2</em>虎牙官方提供包括补贴奖励、个人形象包装在内的明星扶持计划</li>
                                                            <li><em>3</em>官方赛事活动奖励，厂商合作邀请</li>
                                                            <li><em>4</em>推荐资源优先特权，成为虎牙平台顶级明星主播</li>
                                                        </ul>
                                                    </div>
                                                    <div class="mod-tab-bd J_content">
                                                        <div class="mod-tab-content">
                                                            <p>对于直播稳定的优质主播，官方将会与主播联系签约。</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<div class="pop-box-content">
    <!-- 设置自定义标签弹窗 -->
    <div class="box custom-popbox" id="custom_tag_popbox" style="width: 630px;">
        <form class="selected_tag_form" method="post">
            <input id="selected_tag_value" name="label" type="hidden">
        </form>
        <div class="box-hd">
        ...
        <div class="box-bd" style="padding:25px 40px;">
            <p>
                为你自己的直播风格选择一种标签，让你的观众更方便找到你。你也可以设置自定义标签！
            </p>
            <form class="form" id="tag_form">
                <div class="form-group" id="official_tag_container">

                </div>

                <div class="form-action" style="padding-top:100px">
                    <label id="is_set_custom_tag" class="remember" style="margin-right:5px;">
                        <div id="sign_self_box_tick" class="select-icon">
                            <!-- <input type="hidden" id="is_set_custom_tag_value" name=""  value="0"> -->
                        </div>
                        <span>自定义标签</span>
                    </label>
                    <input class="tag-input" id="custom_tag_value" disabled="disabled" placeholder="自定义标签" type="text">
                </div>
                <div class="btn-group" style="text-align:right;">
                        <span class="ui-button">
                            <a href="javascript:void(0);" class="btn btn-confirm J_setTag" style="display:none;">确定</a>
                            <a href="javascript:void(0);" class="btn btn-cancel J_setTagDisable" style="cursor:no-drop;">确定</a>
                        </span>
                    <span class="ui-button ui-button-gray J_btnCancle">
    ...
    <!-- 设置标签结果 -->
    <div class="box custom-popbox-result" id="custom_tag_popbox_result" style="">
        <div class="box-hd">
            <h3 class="title">提示</h3>
            <a href="javascript:void(0);" class="btn-close J_btnCancle" title="关闭">关闭</a>
        </div>
        <div class="box-bd hide" id="tag_result_loading">
            <i>
                <img src="http://assets.dwstatic.com/project/yytv/center/2.9.1/img/loading2.gif">
            </i>
            <p class="info" style="line-height:100px;display:inline;"></p>
        </div>
        <!-- <div class="box-bd hide">
            <i class="icon icon-info"></i>
            <p class="info">自定义标签“刁近平”不可用，请重新设置</p>
            <div class="btn-group">
                <span class="ui-button J_btnConfirm"><a href="javascript:void(0);" class="btn btn-confirm">立即认证</a></span>
                <span class="ui-button ui-button-gray J_btnCancle"><a href="javascript:void(0);" class="btn btn-cancel">取消</a></span>
            </div>
        </div> -->
        <div class="box-bd hide" id="tag_result_error">
            <i class="icon icon-error"></i>
            <p class="info"></p>
            <div class="btn-group">
                <span class="ui-button J_btnCancle J_resetTag"> <a href="javascript:void(0);" class="btn btn-cancel">确定</a></span>
            </div>
        </div>
        <div class="box-bd hide" id="tag_result_success">
            <i class="icon icon-success"></i>
            <p class="info"></p>
            <div class="btn-group">
                <span class="ui-button J_btnCancle"> <a href="javascript:void(0);" class="btn btn-cancel">确定</a></span>
            </div>
        </div>
    </div>
    <!--历史记录明细弹窗-->
    <div class="box pop-history-detail" id="popHistoryDetail" style=" display: none;">
        <div class="box-hd">
            <h3 class="title">日期： <span id="detailTitle"></span></h3>
...
<script src="http://assets.dwstatic.com/b=lego/2.0.0/js&amp;f=lego.switchable.js,lego.popupbox.js" id="navScript"></script>
<script type="text/javascript" src="http://assets.dwstatic.com/project/yytv/center/2.9.2/js/main.js?t=20150103"></script>

<script type="text/javascript" src="http://a.msstatic.com/huya/icenter/2.3/js/author-info.js?20160314V1"></script>
<script type="text/javascript">
    //修改昵称-数据埋点2016-7-18
...
<div class="pop-box-content">
    <div class="box" id="popup-win1">
        ...
        <div class="box-bd">
            <table class="record">
                <tbody><tr style="background: rgb(255, 249, 232) none repeat scroll 0% 0%;">
                    <th>时间</th>
                    <th>解约频道</th>
                    <th>金额</th>
                    <th>状态</th>
    ...
    <div class="box" id="popup-win2" style="">
        <div class="box-hd">
    ...
    <!-- 修改头像验证 -->
    <div class="box" id="AccessTocken" style="">
        <div class="box-hd">
            <h3 class="title">提示</h3>
            <a href="#1" class="btn-close J_btnClose" title="关闭">关闭</a>
        </div>
    ...
    <div class="box" id="popup-succ" style="">
        <div class="box-hd">
            <h3 class="title">提示</h3>
            <a href="#1" class="btn-close J_btnClose" title="关闭">关闭</a>
        </div>
    ...
    <div class="box" id="popup-error" style="">
        <div class="box-hd">
            <h3 class="title">提示</h3>
            <a href="#1" class="btn-close J_btnClose" title="关闭">关闭</a>
        </div>
