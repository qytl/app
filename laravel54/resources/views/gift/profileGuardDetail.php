...
<head>
    ...
    <script src="//hm.baidu.com/hm.js?51700b6c722f5bb4cf39906a596ea41f"></script><script type="text/javascript" src="http://i.huya.com/base/js/jquery-1.7.2.min.js"></script><script type="text/javascript" src="http://i.huya.com/main/statics/js/WdatePicker.js"></script><link href="http://i.huya.com/main/statics/js/skin/WdatePicker.css" rel="stylesheet" type="text/css">
    <style type="text/css">
                ...
                <div class="scroll-content">
                    ...
                    <div class="nav-section" style="padding-bottom:0">
                        ...
                        <ul class="anchor-info">
                            ...
                            <li>
                                <a menu="profileIncome" href="http://i.huya.com/index.php?m=MyAccount&amp;do=profileGiftIncome&amp;from=profileIncome" class="selected">
                        ...
                        <div id="tab-click" class="mod-tab">
                            <div class="mod-tab-hd">
                                <ul class="mod-tab-trigger J_nav">
                                    ...
                                    <li><a href="http://i.huya.com/index.php?m=MyAccount&amp;do=profileGiftList&amp;from=profileIncome">主播礼物清单</a></li>
                                    <li class="selected"><a href="http://i.huya.com/index.php?m=MyAccount&amp;do=profileGuardDetail&amp;from=profileIncome">主播守护明细</a></li>
                            ...
                            <div class="mod-tab-bd J_content">
                                <div class="mod-tab-content">
                                    <div class="calendar">
                                        <form id="timeSelect" action="http://i.huya.com/index.php?m=MyAccount&amp;do=profileGuardDetail&amp;from=profileIncome" method="post">

                                            <label>
                                                <i>时间</i>
                                                <input name="type" value="customize" type="hidden">
                                                <input class="Wdate" id="datetime" name="datetime" onfocus="WdatePicker({dateFmt:'yyyy年MM月',vel:'realdateTime', maxDate: '%y-%M',onpicked:function(){$('#timeSelect').submit();}})" value="2017年10月" type="text">
                                                <input id="realdateTime" name="realdateTime" value="2017-10-01" type="hidden">
                                            </label>
                                            ...
                                            <div class="contribute__total" style="float:right;margin-right:20px;">
                                                <div class="year__contribute">实时显示守护分成金元宝</div>
                                            </div>
                                        </form>
                                    </div>
                                    <table>
